...
- [`14-experience-v2-phase3.md`](14-experience-v2-phase3.md): Homepage experience v2, phase 3 — Neden Teknoify, trust and control, the final CTA and the homepage footer: claim gate (verified / supported / rejected), the legacy contact-form decision, motion, accessibility, performance.
- [`15-secondary-page-shell.md`](15-secondary-page-shell.md): Secondary-page shell — the canonical header and the purple environmental field on every Yetenekler-linked capability page, the legal pages and the isolated Demo Lab: inventory, field and demo sharing architecture (`scripts/shell/sync-shell.mjs`), header destinations, verification.
- [`16-secondary-pages-mobile.md`](16-secondary-pages-mobile.md): Phone and tablet hardening of the Yetenekler-linked capability pages: the audit, the shared responsive layer (`css/01-foundation/shell-responsive.css`), device-matrix results, desktop equivalence, the subscription page decision.
- [`17-tools-navigation-ai-agent.md`](17-tools-navigation-ai-agent.md): The Araçlar navigation taxonomy (six items, one header source stamped into the homepage, every secondary page and the Demo Lab) and the new AI Agent product page: information architecture, copy, the execution vignette, the visual system, verification, open items.
- [`18-canonical-tools-page-system.md`](18-canonical-tools-page-system.md): The canonical Tools page system: the AI Agent grammar extracted into `css/tools/tools-page.css` and `js/experience/tools.js`, the five Araçlar pages (Web Scraping, API & Entegrasyon, RPA, Finansal İndikatör & Botlar, Eğitim & Danışmanlık) recomposed on it, the stamped canonical footer, copy changes, metadata, verification, open items.
- [`19-retire-demo-embedded-experiences.md`](19-retire-demo-embedded-experiences.md): demo.teknoify.com retired to a branded "wrong place" page, every Demo destination removed from the marketing frontend, and the two embedded product experiences (Web Scraping comparison, Finansal İndikatör & Botlar market screen) that replace the demo's role.
- [`20-finance-strategy-language.md`](20-finance-strategy-language.md): Finansal İndikatör & Botlar copy migrated from rule language to strategy language ("Stratejiyi siz seçersiniz, bot uygular."), "temsilî seri" labels removed from the market screen; no layout or chart change.
