...
| `docs/chatbot-api-contract.md`                           | docs           | Chatbot API contract                                                  | rag-platform            | `docs/api-contracts/chatbot-api-contract.md`                                | active         | P1-high     | Contract docs should move before runtime files.                       |
| `docs/chatbot-query-logging-contract.md`                 | docs           | Chatbot query logging contract                                        | rag-platform            | `docs/api-contracts/chatbot-query-logging-contract.md`                      | active         | P1-high     | Important for privacy/logging expectations.                           |
| `docs/rag-document-index-schema.md`                      | docs           | RAG document index schema                                             | rag-platform            | `docs/data-contracts/rag-document-index-schema.md`                          | active         | P1-high     | Data contract candidate.                                              |
| `docs/rag-local-retrieval.md`                            | docs           | RAG local retrieval design                                            | rag-platform            | `docs/rag/local-retrieval.md`                                               | active         | P2-medium   | RAG implementation design.                                            |
| `docs/rag-pipeline-design.md`                            | docs           | RAG pipeline design                                                   | rag-platform            | `docs/rag/pipeline-design.md`                                               | active         | P1-high     | Future service/worker guidance.                                       |
| `docs/rag-text-extraction.md`                            | docs           | RAG text extraction documentation                                     | rag-platform            | `docs/rag/text-extraction.md`                                               | active         | P1-high     | Related to extraction scripts/workflows.                              |
...
| `ARCHITECTURE.md`                                        | docs           | Existing no-build/static MPA architecture notes                       | docs                    | `docs/architecture/legacy-static-mpa.md`                                    | active         | P1-high     | Leave intent intact; use as current context.                          |
| `DEVELOPMENT.md`                                         | docs           | Developer setup and quality commands                                  | docs                    | `docs/deployment/development.md`                                            | active         | P1-high     | Existing command reference.                                           |
