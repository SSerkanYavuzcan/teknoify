...
- [`investment-intelligence-migration-plan.md`](investment-intelligence-migration-plan.md): Phase 5A documentation-only migration plan for the Investment Intelligence domain, including inventory, target structure, risks, smoke tests, and staged migration order.
